...
#include <stddef.h>
#include "vehicle_msg/msg/detail/vehiclepose__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  vehicle_msg__msg__Vehiclepose__init(message_memory);
}

void Vehiclepose__rosidl_typesupport_introspection_c__Vehiclepose_fini_function(void * message_memory)
{
  vehicle_msg__msg__Vehiclepose__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Vehiclepose__rosidl_typesupport_introspection_c__Vehiclepose_message_member_array[3] = {
  {
    ...
    offsetof(vehicle_msg__msg__Vehiclepose, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_msg__msg__Vehiclepose, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vehicle_msg__msg__Vehiclepose, theta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Vehiclepose__rosidl_typesupport_introspection_c__Vehiclepose_message_members = {
  ...
  3,  // number of fields
  sizeof(vehicle_msg__msg__Vehiclepose),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vehicle_msg, msg, Vehiclepose)() {
