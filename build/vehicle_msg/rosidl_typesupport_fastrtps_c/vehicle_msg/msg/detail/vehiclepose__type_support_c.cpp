...
#include "vehicle_msg/msg/detail/vehiclepose__rosidl_typesupport_fastrtps_c.h"
...
using _Vehiclepose__ros_msg_type = vehicle_msg__msg__Vehiclepose;
...
size_t get_serialized_size_vehicle_msg__msg__Vehiclepose(
  const void * untyped_ros_message,
...
static uint32_t _Vehiclepose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_msg__msg__Vehiclepose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_msg
size_t max_serialized_size_vehicle_msg__msg__Vehiclepose(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_vehicle_msg__msg__Vehiclepose(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_msg, msg, Vehiclepose)() {
